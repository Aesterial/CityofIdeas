    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          >
            <h1 className="text-4xl font-bold mb-3">{mode === "login" ? t("authorization") : t("registration")}</h1>
            <p className="text-muted-foreground mb-8">{mode === "login" ? t("heroSubtitle") : t("heroSubtitle")}</p>
          </motion.div>
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder={t("name")}
                      className="w-full bg-card border border-border rounded-2xl py-4 pl-12 pr-4 focus:outline-none focus:ring-2 focus:ring-foreground/20 transition-all duration-300"
                    />
                  </div>
                </motion.div>
              )}
            ...
            >
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full bg-card border border-border rounded-2xl py-4 pl-12 pr-12 focus:outline-none focus:ring-2 focus:ring-foreground/20 transition-all duration-300"
                />
                <button
                  type="button"
          ...
          >
            <button className="w-full bg-card border border-border rounded-2xl py-4 px-6 font-medium hover:bg-muted transition-colors duration-300 flex items-center justify-center gap-3">
              <svg width="230" height="28" viewBox="0 0 276 48" fill="none" xmlns="http://www.w3.org/2000/svg">
