      ...
      <main className="pt-28 pb-16 px-6">
        <div className="container mx-auto max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <h1 className="text-4xl font-bold mb-3">{t("suggestIdea")}</h1>
            <p className="text-muted-foreground mb-10">{t("describeIssue")}</p>
          </motion.div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
              ...
              >
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-card border border-border rounded-2xl py-4 px-5 focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all duration-300"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={5}
                    className="w-full bg-card border border-border rounded-2xl py-4 px-5 focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all duration-300 resize-none"
                  />
                </div>
            ...
            >
              <GradientButton type="submit" className="px-12">
                {t("submitIdea")}
              </GradientButton>
            </motion.div>
          </form>
