...
type Repository interface {
	...
	TicketsByUser(ctx context.Context, user domain.UUID) (Tickets, error)
	// TicketsList returns full list of tickets in range of limit
	TicketsList(ctx context.Context, limit int, offset int) (Tickets, error)
	...
	AcceptTicket(ctx context.Context, target Target)
	...
	MessagesList(ctx context.Context, ticket domain.UUID, limit int, offset int) (Messages, error)
}
