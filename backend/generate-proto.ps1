...
protoc `
    -I $protoRoot `
    -I $googleapis `
    --go_out=internal --go_opt=module=Aesterial/backend/internal `
    --go-grpc_out=internal --go-grpc_opt=module=Aesterial/backend/internal `
    --grpc-gateway_out=internal `
    --grpc-gateway_opt=module=Aesterial/backend/internal `
    $protos